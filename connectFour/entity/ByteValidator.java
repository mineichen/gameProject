...
/**
 * A class which validates and compares byte arrays
 *
 * The byte array consists of two parts a host part and a individual data part
 * If one host part equals another, the data was sent by the same machine
 *
 * @author efux
 */
